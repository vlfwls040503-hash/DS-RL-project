...
|---|---|---|---|---|
| SDLP | 0.104 | 0.786 | 0.137 | 0.0335 |
| 평균속도 | 0.09516 | 0.046 | 27.8 | 27.7 |
| 속도std | 0.3753 | 0.691 | 0.47 | 0.0947 |

### z-space (스타일 분리)
- z-PC1 ↔ SDLP 상관 **0.07**, ↔ 평균속도 **-0.09** (|상관|이 크면 z가 의미있는 스타일축을 잡음)

### 운동학 그럴듯함 (임계 초과 비율)
- |가속|>4 m/s²: 생성 0.000 / 실제 0.000
- |저크|>5 m/s³: 생성 0.002 / 실제 0.000

### 조건효과 재현 (SDLP)
| cond | 실제 SDLP | 생성 SDLP | n |
|---|---|---|---|
| 0 | 0.1365 | 0.03865 | 650 |
| 1 | 0.1385 | 0.02822 | 643 |
...
|---|---|---|---|---|
| SDLP | 0.0954 | 0.591 | 0.1555 | -0.06007 |
| 평균속도 | 8.759 | 0.985 | 0.2491 | 8.51 |
| 속도std | 1.08 | 0.570 | 0.6137 | 0.4661 |
