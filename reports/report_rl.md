...
드라이버 v2.4 = **OU 의도-방황(τ=150m, σ=0.312m)을 저역필터(τ₂=150m, SRR_0.5로 보정)로 평활한 뒤 목표 차선위치(관측 e채널)에 주입** + RL 조향 + 속도 컨트롤러. test 이탈 0/10.
...
| 지표 | 사람 | RL v2.4 |
|---|---|---|
| SRR_0.5 (/km) | 10.1 | **16.4** |
| SRR_2 (/km) | 2.2 | 2.3 |
| 횡속도 반전율 (/km) | 10.7 | 14.0 |
| 횡위치 주파장 (m) | 847 | 1382 |
...
|---|---|---|---|---|---|
| 횡위치 e(m) | 0.0686±0.326 | 0.0327±0.258 | 0.058 | -0.10 | 0.414 |
| 상대 yaw ψ(rad) | 2.17e-06±0.00377 | -2.22e-06±0.00341 | 0.000418 | 0.01 | 0.00511 |
| 횡속도(m/s) | 6.8e-06±0.105 | -0.000563±0.0733 | 0.0131 | 0.01 | 0.13 |
| 횡가속(m/s²) | -0.0897±0.458 | -0.081±0.335 | 0.0805 | 0.82 | 0.294 |
...
|---|---|---|---|
| SDLP | 0.221±0.053 | 0.227±0.063 | 0.018 |
| LPM | 0.068±0.234 | 0.044±0.214 | 0.056 |
| 속도 | 27.720±0.083 | 26.803±0.630 | 0.916 |
| SRR_0.5 | 10.124±2.787 | 16.412±1.993 | 6.289 |
